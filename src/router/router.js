...
import PappasArmhavningar from '../views/trusted/PappasArmhavningar.vue';
...
const routes = [
  ...
  { path: '/trusted/pappas-armhavningar', component: PappasArmhavningar, meta: { roles: ['Trusted', 'Admin'] } },
